...
public class DefaultSortTest extends TestCase {
	...
	public void testGenerateIntData() {
//		Sort test = new DefaultSort();
//		test.generateIntData(10, 100);
//		test.displayIntArray();
//		test.sortInt();
//		test.displayIntArray();
	}

	public void testGenerateDoubleData() {
//		Sort test = new DefaultSort();
//		test.generateDoubleData(10);
//		test.displayDoubleArray();
//		test.sortDouble();
//		test.displayDoubleArray();
	}
